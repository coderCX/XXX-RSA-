...
//    NSData* originData = [signature dataUsingEncoding:NSASCIIStringEncoding];
...
//
//    NSString* decodeStr = [[NSString alloc] initWithData:signatureData encoding:NSASCIIStringEncoding];
//     signatureData = [decodeStr dataUsingEncoding:NSUTF8StringEncoding];
